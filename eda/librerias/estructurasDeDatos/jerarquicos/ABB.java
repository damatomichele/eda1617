...
public class ABB<E extends Comparable<E>> {
    ...
    public ABB(E[] v) {
        E [] sortedArray = v;
        Ordenacion.quickSort(sortedArray);
        this.raiz = construirEquilibrado(sortedArray, 0, sortedArray.length-1);
    }
    ...
    protected NodoABB<E> construirEquilibrado(E[] v, int ini, int fin) {        
        if(ini > fin){ return null; }
              ...
              NodoABB<E> left = construirEquilibrado(v, ini, m-1);
              NodoABB<E> right = construirEquilibrado(v, m+1, fin);
              return new NodoABB(v[m], left, right);
            }        
    }
    ...
    public void reconstruirEquilibrado() {        
        E [] arrayEquilibrado = toArrayInOrden();
        this.raiz = construirEquilibrado(arrayEquilibrado, 0, arrayEquilibrado.length-1);
    }
    ...
    protected E recuperar(E x, NodoABB<E> actual) {
        ...
        } else { return actual.dato;/*super.recuperar( prefijo );*/ }
    }
